...
public class DisplaySettings extends DashboardFragment implements OnPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        try {
            mPitchPreference.setChecked(mOverlayManager.getOverlayInfo("com.cherish.pitchblacksystem", UserHandle.USER_CURRENT).isEnabled());
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mPitchPreference) {
            setOverlay("com.cherish.pitchblacksystem", (Boolean) newValue);
            setOverlay("com.cherish.pitchblacksettings", (Boolean) newValue);
            setOverlay("com.cherish.pitchblacksystemui", (Boolean) newValue);
            return true;
        }
        return false;
    }
