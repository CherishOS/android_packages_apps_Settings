...
public class CherishSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String CHERISH_CPU_MODEL_PROPERTY = "ro.cherish.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelCherish = SystemProperties.get(CHERISH_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelCherish.isEmpty()) {
            return cpuModelCherish;
