...
public class FirmwareVersionDetailPreferenceController extends BasePreferenceController {
    ...
    @VisibleForTesting
    private static final String CHERISH_PLATFORM_RELEASE_OR_CODENAME = "ro.cherish.platform_release_or_codename";
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(CHERISH_PLATFORM_RELEASE_OR_CODENAME, 
