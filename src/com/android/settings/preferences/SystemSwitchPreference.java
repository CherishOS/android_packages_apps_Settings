...
public class SystemSwitchPreference extends SwitchPreference {
    ...
    private void init() {
        ...
        switch (settingsKey) {
            case SYSTEM:
            default:
                isChecked = Settings.System.getIntForUser(mContext.getContentResolver(), getKey(), 0,
                        UserHandle.USER_CURRENT) != 0;
                break;
            case SECURE:
                isChecked = Settings.Secure.getIntForUser(mContext.getContentResolver(), getKey(), 0,
                        UserHandle.USER_CURRENT) != 0;
                break;
            case GLOBAL:
        ...
        setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                switch (settingsKey) {
                    case SYSTEM:
                    default:
                        Settings.System.putIntForUser(mContext.getContentResolver(), getKey(), intValue,
                                UserHandle.USER_CURRENT);
                        break;
                    case SECURE:
                        Settings.Secure.putIntForUser(mContext.getContentResolver(), getKey(), intValue,
                                UserHandle.USER_CURRENT);
                        break;
                    case GLOBAL:
